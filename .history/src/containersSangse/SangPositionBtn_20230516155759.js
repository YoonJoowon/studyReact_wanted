...
function SangPositionBtn() {
  ...
  return (
    <SangPositionBtnStyle>
      <button className="bookmarkBtn" type="button" onClick={handleClickMark}>
        <svg
          width="22"
          height="22"
          viewBox="0 0 18 18"
        ...
        >
          ...
          ></path>
            <path
              ...
              fill={isFilled ? "black" : "blue"}
              fillOpacity={isFilled ? "0.25" : "0.6"}
            ></path>
        </svg>
      </button>
    </SangPositionBtnStyle>
...
export default SangPositionBtn;

const SangPositionBtnStyle = styled.div`
  .bookmarkBtn {
    cursor: pointer;
  }
`;
