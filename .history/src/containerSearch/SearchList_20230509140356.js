...
function SearchList(props) {
  useEffect(() => {
    // props.location.state.closeSearch를 호출하여 closeSearch 함수를 실행시킵니다.
    if (props.location && props.location.state && props.location.state.closeSearch) {
      const closeSearch = props.location.state.closeSearch;
      closeSearch();
    }
  }, );
