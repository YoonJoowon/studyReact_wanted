      ...
      <div>
        ...
        <div class="">
          <div class="">
            <div>
            <div class="">
              <div class="ResumeList_ResumeList_addItem__Aifx4">
                <div class="ResumeList_ResumeList_addItem_icon__yfHFj">
                  <svg width="22" height="22" viewBox="0 0 16 16" fill="none" xmlns="https://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M12.25 0H0.75C0.335786 0 0 0.335786 0 0.75V12.25C0 12.6642 0.335786 13 0.75 13H3V15.25L3.00685 15.3518C3.05651 15.7178 3.3703 16 3.75 16H15.25L15.3518 15.9932C15.7178 15.9435 16 15.6297 16 15.25V3.75L15.9932 3.64823C15.9435 3.28215 15.6297 3 15.25 3L15.1482 3.00685C14.7822 3.05651 14.5 3.3703 14.5 3.75L14.499 14.499H4.499L4.49975 13H12.25C12.6642 13 13 12.6642 13 12.25V0.75C13 0.335786 12.6642 0 12.25 0ZM11.499 1.5V11.5H1.499V1.5H11.499Z" fill="#fff"></path></svg></div><p>새 이력서 작성</p></div></div></div></div><div class="ResumeItem_ResumeItem__MnI_V" data-attribute-id="" role="button">
                      <div class="ResumeList_ResumeList_upload___7VWD" tabindex="0">
                        <input multiple="" type="file" autocomplete="off" tabindex="-1" data-attribute-id="resumeList__resume__uploadFile" style="display: none;">
                          <div class="ResumeList_ResumeList_upload_icon__3SGaN">
                            <svg xmlns="https://www.w3.org/2000/svg" width="26" height="28" viewBox="0 0 32 34">
                                      ...
                                      <path d="M25.6 20.117L25.6 28.579 0 28.617 0 20.154M12.8.708L12.8 21.108" transform="translate(-543 -398) translate(543 398) translate(3.2 2.55)"></path><path d="M18.8 0L12.8 7.083 6.8 0" transform="translate(-543 -398) translate(543 398) translate(3.2 2.55) rotate(-180 12.8 3.542)">
                                        </path></svg></div>
                                        <p>파일 업로드</p>
                                        </div>
                                        </div>
