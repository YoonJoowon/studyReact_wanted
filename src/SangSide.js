            ...
            <div className="aside1">
                <div className="aside1_padding">
                    ...
                    <div className="aside1_bookmark_btn">
                        <button className="" type="button" data-attribute-id="position__bookmark__click" data-job-category-id="518" data-job-category="IT" data-company-id="22333" data-company-name="블루비커" data-position-id="91536" data-position-name="웹 프론트엔드 개발자(React)" data-kind="add">
                            <svg width="13" height="17" viewBox="0 0 13 17"><defs>
                                <path id="bookmarkIconLine" d="M1.481 1.481h9.382v10.727c0 .409.331.74.74.74.41 0 .741-.331.741-.74V.74c0-.41-.331-.741-.74-.741H.74C.33 0 0 .332 0 .74v14.814c0 .568.614.925 1.108.643l5.18-2.873 5.104 2.873c.355.203.807.08 1.01-.276.203-.355.08-.808-.275-1.01l-5.471-3.083c-.228-.13-.507-.13-.735 0l-4.44 2.45V1.48z">

                                </path></defs><g fill="none" fillRule="evenodd"><use fill="currentColor" ></use></g>
                            </svg>북마크하기
                        </button>
                    </div>
                    <div>
                        <button className="aside1_end_btn" disabled="" type="button">지원마감</button>
                    </div>

                    <div className="aside1_bottom">
                        <button className="aside1_bottom_btn1" type="button" data-attribute-id="position__like__click" data-job-category-id="518" data-job-category="IT" data-company-id="22333" data-company-name="블루비커" data-position-id="91536" data-position-name="웹 프론트엔드 개발자(React)" data-kind="add">
                            <div>
                                <p className="">
                                    <svg className="" viewBox="0 0 24 24">
                                        <path d="M11.9999 6.49201L13.4848 5.00461C15.5225 2.9634 18.8529 2.9634 20.8905 5.00445C22.9308 7.04707 22.9308 10.3876 20.8928 12.4291L13.4587 19.9397L13.4565 19.9419C13.067 20.332 12.5427 20.5339 11.9999 20.5261C11.4563 20.5339 10.9319 20.3321 10.5402 19.9397L3.10804 12.4311C1.06908 10.3875 1.06908 7.04719 3.10835 5.00445C5.14712 2.96345 8.47614 2.96345 10.5151 5.00461L11.9999 6.49201Z" fill="#e1e2e3">
                        ...
                        <button type="button" className="aside1_bottom_btn2" data-attribute-id="position__like__list" data-position-id="91536" data-position-name="웹 프론트엔드 개발자(React)">
                            <ul>
                                ...
                                <li className="aside1_bottom_btn2_2" style={{ backgroundImage: "url('https://k.kakaocdn.net/dn/chOGWm/btrJ7se3l3K/eeQiZuGgc7rBHKj9Rbr/Fk1/img_110x110.jpg'), url('https://static.wanted.co.kr/images/userweb/profile_default.png')" }}>
                                </li>
                                <li className="aside1_bottom_btn2_3" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/a/ALm5wu2bYv18aK6_ahAXODnanhRHwCfEqvoUbqKJCBKA=s96-c'), url('https://static.wanted.co.kr/images/userweb/profile_default.png')" }}>
                                </li>
                            </ul>
                        </button>
                    </div>
