            ...
            <main className="main_main">
                ...
                <section className="section2">
                    ...
                    <div className="section2_top">
                        <h6 className="section2_text1">
                            블루비커
                        </h6>
                        <div className="">
                            <button className="" type="button">
                                <div className="section2_high">
                                    응답률 매우 높음
                                </div>
                                {/* <!-- <div className="">지원 후 응답받을 확률이 95% 이상입니다.</div> --> */}
                            </button>
                        </div>
                        <span className="section2_korea">서울 한국
                        </span>
                    </div>
                ...
                <section className="section4">
                    <div className="section4_top">
                        ...
                        <div className="section4_top_1">
                            ...
                            <div className="section4_top_text2">서울 용산구 한강대로 366 트윈시티 남산 2 패스트파이브</div>
                        </div>
                        <div>
                            <a className="" href="https://map.naver.com/?dlevel=13&amp;pinTitle=서울특별시 용산구 한강대로 366 트윈시티 남산&amp;lat=37.5511247&amp;lng=126.9729133" rel="noreferrer noopener" target="_blank">
                                <img alt="Map with company address" src="https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyMjAzMjhfODkg%2FMDAxNjQ4NDc4MjE4NTYz.p2LFzI3uXxH-hWnhhEZ9lv9KQAStSBZF8H8wg_gkUyMg.Dx4fyIHh6w7gCsZyMzVQEwjUP8HGuSjCD8EQB74PuIcg.PNG.pmh6927%2F20220328_233504.png&type=sc960_832" /></a>
                        </div>
                    </div>
                    <div className="section4_mid">

                        <div className="section4_mid_logo" style={{ backgroundImage: `url(https://static.wanted.co.kr/images/wdes/0_5.0852ff23.jpg)` }}>
                        </div>
                        ...
                        <div>
                            <button className="section4_mid_btn" data-attribute-id="company__follow__click" data-kind="add">
                    ...
                    <div className="section4_bot">
                        ...
                        <div className="section4_bot_txt">본 채용정보는 원티드랩의 동의없이 무단전재, 재배포, 재가공할 수 없으며, <br /> 구직활동 이외의 용도로 사용할 수 없습니다.</div>
                        <svg className="section4_bot_arrow" viewBox="0 0 19 19"><path d="M2.71967 5.71967C2.98594 5.4534 3.4026 5.4292 3.69621 5.64705L3.78033 5.71967L9.499 11.438L15.2162 5.7211C15.4824 5.45479 15.899 5.43051 16.1927 5.64832L16.2768 5.72092C16.5431 5.98715 16.5674 6.40381 16.3496 6.69745L16.277 6.78158L10.0304 13.0302C9.76416 13.2966 9.34745 13.3208 9.0538 13.103L8.96967 13.0303L2.71967 6.78033C2.42678 6.48744 2.42678 6.01256 2.71967 5.71967Z" fill="currentColor"></path></svg>
                        ...
                        <ul data-cy="job-list">
                            <li>
                                <div data-cy="job-card" className="fatureContainer01">
                                    ...
                                    <img style={{backgroundImage: `url(https://image.wanted.co.kr/optimize?src=https%3A%2F%2Fstatic.wanted.co.kr%2Fimages%2Fcompany%2F52%2F17418_2_0.abfaf8d8__400_400.jpg&w=400&q=75)`}} />


                                    <div className="fatureContainer01_body">
                                        <div className="fatureContainer01_1">전략기획</div>
                                        <div className="fatureContainer01_2">아이엔지스토리</div>
                            ...
                            <li>
                                <div data-cy="job-card" className="fatureContainer02">
                                    ...
                                    <img style={{backgroundImage: "url(https://image.wanted.co.kr/optimize?src=https%3A%2F%2Fstatic.wanted.co.kr%2Fimages%2Fcompany%2F70%2Ftdeu7osbz2hkiaek__400_400.jpg&w=400&q=75)"}}></img>

                                    <div className="fatureContainer01_body">
                                        <div className="fatureContainer01_1">해외 파트너십 마케팅</div>
                                        <div className="fatureContainer01_2">스와치온(SwatchOn)</div>
                                        <div className="fatureContainer01_3">서울<span className="addressDot">.</span><span>한국</span></div>
                                        <div className="fatureContainer01_4">채용보상금 1,000,000원</div>
                                    </div>
                                </div>
                            ...
                            <li>
                                <div data-cy="job-card" className="fatureContainer03">
                                    ...
                                    <div className="fatureContainer01_body">
                                        <div className="fatureContainer01_1">Sales Account Executive [AE팀]</div>
                                        <div className="fatureContainer01_2">원티드랩</div>
                            ...
                            <li>
                                <div data-cy="job-card" className="fatureContainer04">
                                    ...
                                    <img style={{backgroundImage: 'url(https://image.wanted.co.kr/optimize?src=https%3A%2F%2Fstatic.wanted.co.kr%2Fimages%2Fcompany%2F5%2Fpcufn5hokw5zrpwf__400_400.jpg&w=400&q=75)'}} />

                                    <div className="fatureContainer01_body">
                                        <div className="fatureContainer01_1">콘텐츠 마케터</div>
                                        <div className="fatureContainer01_2">코스트</div>
                                        <div className="fatureContainer01_3">서울<span className="addressDot">.</span><span>한국</span></div>
                                        <div className="fatureContainer01_4">채용보상금 1,000,000원</div>
                                    </div>
                                </div>
                            ...
                            <li>
                                <div data-cy="job-card" className="fatureContainer05">
                                    <button className="bookmarkBtn" type="button" aria-label="bookmark button" data-attribute-id="position__bookmark__click" data-kind="add" data-job-category-id="523" data-job-category="Marketing &amp; Advertising" data-company-id="39517" data-company-name="아이엔지스토리" data-position-id="152842" data-position-name="전략기획">
                                        <svg width="22" height="22" viewBox="0 0 18 18" fill="none" xmlns="https://www.w3.org/2000/svg">
                                            <path fillRule="evenodd" clip-rule="evenodd" d="M3.58065 1C3.25997 1 3 1.26206 3 1.58533V16.4138C3 16.8632 3.48164 17.145 3.86873 16.922L9.00004 13.9662L14.1313 16.922C14.5184 17.145 15 16.8632 15 16.4138V1.58533C15 1.26206 14.74 1 14.4194 1H9.00004H3.58065ZM8.71195 12.7838C8.89046 12.681 9.10961 12.681 9.28812 12.7838L13.8387 15.4052V2.17067H9.00004H4.1613V15.4052L8.71195 12.7838Z" fill="white"></path>
                                            <path d="M9.28812 12.7838C9.10961 12.681 8.89046 12.681 8.71195 12.7838L4.1613 15.4052V2.17067H9.00004H13.8387V15.4052L9.28812 12.7838Z" fill="black" fill-opacity="0.25"></path>
                                    ...
                                    <img style={{backgroundImage: "url('https://image.wanted.co.kr/optimize?src=https%3A%2F%2Fstatic.wanted.co.kr%2Fimages%2Fcompany%2F2%2Fhinwuwajtutmkdvf__400_400.jpg&w=400&q=75')"}} />
                            ...
                            <li>
                                <div data-cy="job-card" className="fatureContainer06">
                                    <button className="bookmarkBtn" type="button" aria-label="bookmark button" data-attribute-id="position__bookmark__click" data-kind="add" data-job-category-id="523" data-job-category="Marketing &amp; Advertising" data-company-id="8177" data-company-name="스와치온(SwatchOn)" data-position-id="151227" data-position-name="해외 파트너십 마케팅">
                                        <svg width="22" height="22" viewBox="0 0 18 18" fill="none" xmlns="https://www.w3.org/2000/svg">
                                            <path fillRule="evenodd" clip-rule="evenodd" d="M3.58065 1C3.25997 1 3 1.26206 3 1.58533V16.4138C3 16.8632 3.48164 17.145 3.86873 16.922L9.00004 13.9662L14.1313 16.922C14.5184 17.145 15 16.8632 15 16.4138V1.58533C15 1.26206 14.74 1 14.4194 1H9.00004H3.58065ZM8.71195 12.7838C8.89046 12.681 9.10961 12.681 9.28812 12.7838L13.8387 15.4052V2.17067H9.00004H4.1613V15.4052L8.71195 12.7838Z" fill="white"></path>
                                            <path d="M9.28812 12.7838C9.10961 12.681 8.89046 12.681 8.71195 12.7838L4.1613 15.4052V2.17067H9.00004H13.8387V15.4052L9.28812 12.7838Z" fill="black" fill-opacity="0.25"></path>
                                    ...
                                    <img style={{backgroundImage: "url(https://image.wanted.co.kr/optimize?src=https%3A%2F%2Fstatic.wanted.co.kr%2Fimages%2Fcompany%2F35%2Fwl4mb18qp45k1aum__400_400.jpg&w=400&q=75)"}} />
                            ...
                            <li>
                                <div data-cy="job-card" className="fatureContainer07">
                                    <button className="bookmarkBtn" type="button" aria-label="bookmark button" data-attribute-id="position__bookmark__click" data-kind="add" data-job-category-id="530" data-job-category="Sales" data-company-id="79" data-company-name="원티드랩" data-position-id="152319" data-position-name="Sales Account Executive [AE팀]">
                                        <svg width="22" height="22" viewBox="0 0 18 18" fill="none" xmlns="https://www.w3.org/2000/svg">
                                            <path fillRule="evenodd" clip-rule="evenodd" d="M3.58065 1C3.25997 1 3 1.26206 3 1.58533V16.4138C3 16.8632 3.48164 17.145 3.86873 16.922L9.00004 13.9662L14.1313 16.922C14.5184 17.145 15 16.8632 15 16.4138V1.58533C15 1.26206 14.74 1 14.4194 1H9.00004H3.58065ZM8.71195 12.7838C8.89046 12.681 9.10961 12.681 9.28812 12.7838L13.8387 15.4052V2.17067H9.00004H4.1613V15.4052L8.71195 12.7838Z" fill="white"></path>
                                            <path d="M9.28812 12.7838C9.10961 12.681 8.89046 12.681 8.71195 12.7838L4.1613 15.4052V2.17067H9.00004H13.8387V15.4052L9.28812 12.7838Z" fill="black" fill-opacity="0.25"></path>
                                    ...
                                    <img style={{backgroundImage: 'url(https://image.wanted.co.kr/optimize?src=https%3A%2F%2Fstatic.wanted.co.kr%2Fimages%2Fcompany%2F53%2Fzkuycl59i67pmnhl__400_400.jpg&w=400&q=75)'}} />
                            ...
                            <li>
                                <div data-cy="job-card" className="fatureContainer08">
                                    <button className="bookmarkBtn" type="button" aria-label="bookmark button" data-attribute-id="position__bookmark__click" data-kind="add" data-job-category-id="523" data-job-category="Marketing &amp; Advertising" data-company-id="35834" data-company-name="코스트" data-position-id="152265" data-position-name="콘텐츠 마케터">
                                        <svg width="22" height="22" viewBox="0 0 18 18" fill="none" xmlns="https://www.w3.org/2000/svg">
                                            <path fillRule="evenodd" clip-rule="evenodd" d="M3.58065 1C3.25997 1 3 1.26206 3 1.58533V16.4138C3 16.8632 3.48164 17.145 3.86873 16.922L9.00004 13.9662L14.1313 16.922C14.5184 17.145 15 16.8632 15 16.4138V1.58533C15 1.26206 14.74 1 14.4194 1H9.00004H3.58065ZM8.71195 12.7838C8.89046 12.681 9.10961 12.681 9.28812 12.7838L13.8387 15.4052V2.17067H9.00004H4.1613V15.4052L8.71195 12.7838Z" fill="white"></path>
                                            <path d="M9.28812 12.7838C9.10961 12.681 8.89046 12.681 8.71195 12.7838L4.1613 15.4052V2.17067H9.00004H13.8387V15.4052L9.28812 12.7838Z" fill="black" fill-opacity="0.25"></path>
                                    ...
                                    <img style={{backgroundImage: "url(https://image.wanted.co.kr/optimize?src=https%3A%2F%2Fstatic.wanted.co.kr%2Fimages%2Fcompany%2F40%2Fregsgtrcawqao1jk__400_400.jpg&w=400&q=75)"}} />
                            ...
                            <li>
                                <div data-cy="job-card" className="fatureContainer09">
                                    <button className="bookmarkBtn" type="button" aria-label="bookmark button" data-attribute-id="position__bookmark__click" data-kind="add" data-job-category-id="523" data-job-category="Marketing &amp; Advertising" data-company-id="39517" data-company-name="아이엔지스토리" data-position-id="152842" data-position-name="전략기획">
                                        <svg width="22" height="22" viewBox="0 0 18 18" fill="none" xmlns="https://www.w3.org/2000/svg">
                                            <path fillRule="evenodd" clip-rule="evenodd" d="M3.58065 1C3.25997 1 3 1.26206 3 1.58533V16.4138C3 16.8632 3.48164 17.145 3.86873 16.922L9.00004 13.9662L14.1313 16.922C14.5184 17.145 15 16.8632 15 16.4138V1.58533C15 1.26206 14.74 1 14.4194 1H9.00004H3.58065ZM8.71195 12.7838C8.89046 12.681 9.10961 12.681 9.28812 12.7838L13.8387 15.4052V2.17067H9.00004H4.1613V15.4052L8.71195 12.7838Z" fill="white"></path>
                                            <path d="M9.28812 12.7838C9.10961 12.681 8.89046 12.681 8.71195 12.7838L4.1613 15.4052V2.17067H9.00004H13.8387V15.4052L9.28812 12.7838Z" fill="black" fill-opacity="0.25"></path>
                                    ...
                                    <img style={{backgroundImage: "url(https://image.wanted.co.kr/optimize?src=https%3A%2F%2Fstatic.wanted.co.kr%2Fimages%2Fcompany%2F39517%2F8coxxmptdjimx8kk__400_400.jpg&w=400&q=75)"}} />
                            ...
                            <li>
                                <div data-cy="job-card" className="fatureContainer10">
                                    <button className="bookmarkBtn" type="button" aria-label="bookmark button" data-attribute-id="position__bookmark__click" data-kind="add" data-job-category-id="523" data-job-category="Marketing &amp; Advertising" data-company-id="8177" data-company-name="스와치온(SwatchOn)" data-position-id="151227" data-position-name="해외 파트너십 마케팅">
                                        <svg width="22" height="22" viewBox="0 0 18 18" fill="none" xmlns="https://www.w3.org/2000/svg">
                                            <path fillRule="evenodd" clip-rule="evenodd" d="M3.58065 1C3.25997 1 3 1.26206 3 1.58533V16.4138C3 16.8632 3.48164 17.145 3.86873 16.922L9.00004 13.9662L14.1313 16.922C14.5184 17.145 15 16.8632 15 16.4138V1.58533C15 1.26206 14.74 1 14.4194 1H9.00004H3.58065ZM8.71195 12.7838C8.89046 12.681 9.10961 12.681 9.28812 12.7838L13.8387 15.4052V2.17067H9.00004H4.1613V15.4052L8.71195 12.7838Z" fill="white"></path>
                                            <path d="M9.28812 12.7838C9.10961 12.681 8.89046 12.681 8.71195 12.7838L4.1613 15.4052V2.17067H9.00004H13.8387V15.4052L9.28812 12.7838Z" fill="black" fill-opacity="0.25"></path>
                            ...
                            <li>
                                <div data-cy="job-card" className="fatureContainer11">
                                    <button className="bookmarkBtn" type="button" aria-label="bookmark button" data-attribute-id="position__bookmark__click" data-kind="add" data-job-category-id="530" data-job-category="Sales" data-company-id="79" data-company-name="원티드랩" data-position-id="152319" data-position-name="Sales Account Executive [AE팀]">
                                        <svg width="22" height="22" viewBox="0 0 18 18" fill="none" xmlns="https://www.w3.org/2000/svg">
                                            <path fillRule="evenodd" clip-rule="evenodd" d="M3.58065 1C3.25997 1 3 1.26206 3 1.58533V16.4138C3 16.8632 3.48164 17.145 3.86873 16.922L9.00004 13.9662L14.1313 16.922C14.5184 17.145 15 16.8632 15 16.4138V1.58533C15 1.26206 14.74 1 14.4194 1H9.00004H3.58065ZM8.71195 12.7838C8.89046 12.681 9.10961 12.681 9.28812 12.7838L13.8387 15.4052V2.17067H9.00004H4.1613V15.4052L8.71195 12.7838Z" fill="white"></path>
                                            <path d="M9.28812 12.7838C9.10961 12.681 8.89046 12.681 8.71195 12.7838L4.1613 15.4052V2.17067H9.00004H13.8387V15.4052L9.28812 12.7838Z" fill="black" fill-opacity="0.25"></path>
                            ...
                            <li>
                                <div data-cy="job-card" className="fatureContainer12">
                                    <button className="bookmarkBtn" type="button" aria-label="bookmark button" data-attribute-id="position__bookmark__click" data-kind="add" data-job-category-id="523" data-job-category="Marketing &amp; Advertising" data-company-id="35834" data-company-name="코스트" data-position-id="152265" data-position-name="콘텐츠 마케터">
                                        <svg width="22" height="22" viewBox="0 0 18 18" fill="none" xmlns="https://www.w3.org/2000/svg">
                                            <path fillRule="evenodd" clip-rule="evenodd" d="M3.58065 1C3.25997 1 3 1.26206 3 1.58533V16.4138C3 16.8632 3.48164 17.145 3.86873 16.922L9.00004 13.9662L14.1313 16.922C14.5184 17.145 15 16.8632 15 16.4138V1.58533C15 1.26206 14.74 1 14.4194 1H9.00004H3.58065ZM8.71195 12.7838C8.89046 12.681 9.10961 12.681 9.28812 12.7838L13.8387 15.4052V2.17067H9.00004H4.1613V15.4052L8.71195 12.7838Z" fill="white"></path>
                                            <path d="M9.28812 12.7838C9.10961 12.681 8.89046 12.681 8.71195 12.7838L4.1613 15.4052V2.17067H9.00004H13.8387V15.4052L9.28812 12.7838Z" fill="black" fill-opacity="0.25"></path>
